# -*- coding: utf-8 -*-
"""
 @file   make_dataset_for_train.py
...
subdataset        = "ToyTrain"       # "ToyCar" or "ToyConveyor"
case_num          = "case1"
ch_num            = ["ch1", "ch2", "ch3", "ch4"]
target_fs         = 16000
num_train_samples = 1000
target_gain       = 10**(10/20) # 10 dB for ToyTrain
noise_gain        = 10**( 0/20) # 0 dB for Train
normal_dir        = dataset_base+"/"+subdataset+"/"+case_num+"/NormalSound_IND/*"
anomaly_dir       = dataset_base+"/"+subdataset+"/"+case_num+"/AnomalousSound_IND/*"
noise_dir         = dataset_base+"/"+subdataset+"/EnvironmentalNoise_CNT/*"+case_num+"*"
